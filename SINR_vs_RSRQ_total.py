...
print('Maximum Averaged RSRQ TM4 : ', max(x0_scaled))
print('Minimum Averaged RSRQ TM4 : ', min(x0_scaled))
print('Maximum Averaged RSRQ TM8 : ', max(x00_scaled))
print('Minimum Averaged RSRQ TM8 : ', min(x00_scaled))
...
axs.set_xlabel('Scaled RSRQ')
axs.set_ylabel('SINR in db')
axs.set_title('SINR vs RSRQ')
