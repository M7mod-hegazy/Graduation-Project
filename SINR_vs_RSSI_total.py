...
print('Maximum Averaged RSSI TM4 : ', max(x0_scaled))
print('Minimum Averaged RSSI TM4 : ', min(x0_scaled))
print('Maximum Averaged RSSI TM8 : ', max(x00_scaled))
print('Minimum Averaged RSSI TM8 : ', min(x00_scaled))
...
axs.set_xlabel('Scaled RSSI')
axs.set_ylabel('SINR in db')
axs.set_title('SINR vs RSSI')
